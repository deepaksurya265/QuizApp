...
import com.wiates.quizapp.Adapters.ListTestAdapterForAdmin;
...
public class ViewAttempts extends AppCompatActivity {
    ...
    private ListTestAdapterForAdmin listTestAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_attempts2);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result!=null){
                if (result.matches("NOTOK")){
                    ...
                    linearLayoutManager = new LinearLayoutManager(ViewAttempts.this, LinearLayoutManager.VERTICAL, false);
                    recyclerView.setLayoutManager(linearLayoutManager);

                    listTestAdapter = new ListTestAdapterForAdmin(ViewAttempts.this, testListModels);
