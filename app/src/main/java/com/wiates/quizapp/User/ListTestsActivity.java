...
public class ListTestsActivity extends AppCompatActivity {
    ...
    private ListTestAdapterStudent listTestAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_tests2);
        ...
        protected void onPostExecute(String result) {
            ...
            if(result!=null){
                if (result.matches("NOTOK")){
                    ...
                    linearLayoutManager = new LinearLayoutManager(ListTestsActivity.this, LinearLayoutManager.VERTICAL, false);
                    recyclerView.setLayoutManager(linearLayoutManager);

                    listTestAdapter = new ListTestAdapterStudent(ListTestsActivity.this, testListModels);
