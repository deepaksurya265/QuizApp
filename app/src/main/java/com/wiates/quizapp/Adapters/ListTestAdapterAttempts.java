...
public class ListTestAdapterAttempts extends RecyclerView.Adapter<ListTestAdapterAttempts.ViewHolder> {
    ...
    public ListTestAdapterAttempts
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!user.matches("NOID")){
                    ...
                    String sql = "SELECT * from appathon_quiz_attempts where quiz_id = '"+testListModel.getQuiz_id()+"' and user_id = '"+userModels.get(0).getId()+"';";

                    new GetAttempt().execute(sql);
                }
